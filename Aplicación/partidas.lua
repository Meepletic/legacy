...
function escena:create(evento)
    ...
    local titulo = display.newText("Perfil (partidas)", display.contentCenterX, 125, native.systemFont, 32)
    ...
    grupo:insert(fondo)
    grupo:insert(titulo)
    grupo:insert(botonJuegos)
    grupo:insert(botonPartidas)
    grupo:insert(botonAmigos)
end
